 ...
 * 2020-02-01T08:23:12.112+07:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "ITSWebService",
                  wsdlLocation = "file:/E:/TNSDemoApp/ITSWebserviceCxfClient/config/ITSSample.wsdl",
...
public class ITSWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/TNSDemoApp/ITSWebserviceCxfClient/config/ITSSample.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ITSWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/TNSDemoApp/ITSWebserviceCxfClient/config/ITSSample.wsdl");
        }
        WSDL_LOCATION = url;
    }
